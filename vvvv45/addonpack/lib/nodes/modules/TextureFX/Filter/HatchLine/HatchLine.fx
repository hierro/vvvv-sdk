...
float4 p0(float2 vp : vpos): COLOR
{
	...
	return lerp(ColorA,ColorB,any(((r2d(vp-R*.5,rot)+R).y)%thickness < col.rgb * threshold))*float4(1,1,1,col.a);
}

void vs2d( inout float4 vp:POSITION, inout float2 uv:TEXCOORD0){vp.xy*=2;uv+=0.5/R;}
technique HatchLine{pass pp0{vertexshader=compile vs_3_0 vs2d();pixelshader=compile ps_3_0 p0();}}