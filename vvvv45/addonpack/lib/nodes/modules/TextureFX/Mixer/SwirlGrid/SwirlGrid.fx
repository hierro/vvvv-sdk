...
float4 p0(float2 uv : TEXCOORD0) :COLOR
{
	...
	angle += distanceFromCenter * distanceFromCenter * cellTwistAmount * Fader;
	float2 newUV2;
...
technique SwirlGrid{pass pp0{vertexshader=compile vs_3_0 vs2d();pixelshader=compile ps_3_0 p0();}}
